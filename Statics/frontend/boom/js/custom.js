...
$(document).ready(function () {
   ...
   if($('.ybc-menu-toggle-h2').length > 0){
        $('.ybc-menu-toggle-h2').off().on('click', function(e){
            e.preventDefault();
            if($('.menu_and_cattree').hasClass('active')){
                 $('.menu_and_cattree').removeClass('active');
                 $('.menu_and_cattree.home2 .ets_mm_megamenu').slideUp( "slow", function() {
                    // Animation complete.
                  });
            }
            else {
                $('.menu_and_cattree').addClass('active');
                $('.menu_and_cattree.home2 .ets_mm_megamenu').slideDown( "slow", function() {
                    // Animation complete.
                 });
            }
        });
